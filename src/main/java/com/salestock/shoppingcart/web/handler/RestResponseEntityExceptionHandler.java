package com.salestock.shoppingcart.web.handler;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(value = { com.salestock.shoppingcart.exception.ResourceNotFoundException.class })
	protected ResponseEntity<Object> handleResourceNotFoundException(com.salestock.shoppingcart.exception.ResourceNotFoundException ex,
			WebRequest request) {
		logger.error(ex.getMessage(), ex);
		com.salestock.shoppingcart.model.ErrorResponse errorResponse = new com.salestock.shoppingcart.model.ErrorResponse();
